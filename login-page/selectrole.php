    ...
    <div class="contents order-2 order-md-1">
        ...
        <div class="row align-items-center justify-content-center">
          ...
          <br>
            ...
            <div style="text-align: center">
                <button type="button" class="btn btn-primary" style="background-color:#00cdc1;width:350px;height:55px;border:none;border-radius:4px;"  data-bs-toggle="modal" data-bs-target="#Org">
...
<!-- //Code for Pet Adopter-->
<?php
if(isset($_POST['adopter']))
{
...
<div class="modal fade" id="Adopter" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Pet Adopter Registration</h5>
      ...
      <form class="login100-form validate-form" method="post">
            ...
            <div class="input-group">
              ...
              <input type="text" aria-label="Email" class="form-control" style="background-color:#f1f1f1;border-radius:5px;border:#00cdc1;font-family:Arial;" data-validate = "Valid email is required: ex@abc.xyz" name="Email">
              &nbsp
            ...
            <br>
					...
					<div style="text-align: center">
						<button  class="login100-form-btn" style="background-color:#00cdc1;width:300px;height:40px;border-radius:5px;border:#00cdc1;" name="adopter">
...
<!-- Modal for Animal Welfare Organization-->
<div class="modal fade" id="Org" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Animal Welfare Organization Registration</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        ...
