...
if(isset($_POST['insert']))
{
  ...
  else
  {
    ...
    else
    {
      ...
      echo "<script type ='text/javascript'> document.location='http://localhost/developgetpet/login-page/P.O-OTP.php'</script>";
  ...
  <div class="d-lg-flex half">
    ...
    <div class="container">
      <div class="row align-items-center justify-content-center">  
          ...
          <br>
            <h5 style="text-align:center;margin-top:-14px;margin-left:-10px;">PET OWNER <strong>REGISTRATION FORM</strong></h5>
            <br>
