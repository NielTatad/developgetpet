  ...
  <div class="d-lg-flex half">
    ...
    <div class="container">
      <div class="row align-items-center justify-content-center">  
          ...
          <p style="text-align:center;"><img src="images/Logo.png" style="width:250px;height:250px;margin-bottom:-90px;margin-top:-278px;margin-right:-15px;" alt=" " class="img-responsive"/></p>
          </a>    
          <br>
            <h5 style="text-align:center;margin-top:-14px;margin-left:-10px;">ANIMAL WELFARE ORGANIZATION <strong>REGISTRATION</strong></h5>
    ...
    <div class="modal-content">
      ...
      <form class="login100-form validate-form" method="post">
            ...
            <div class="input-group">
              <span class="input-group-text" style="float:right;">Organization Name</span>
              <input type="text" aria-label="First name" class="form-control" style="background-color:#f1f1f1;" name="Firstname">
              &nbsp
              <span class="input-group-text" style="float:right;">FullName</span>
