      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-7">
            ...
            <strong style="font-size:14px;" >Email ID:</strong>
            ...
            <br>
            <form action="#" method="post">
            <strong style="font-size:14px;" >Old Password:</strong>
            <div style="text-align: center" class="wrap-input100 validate-input">
						<input class="input100" style="background-color:#f1f1f1;width:300px;height:40px;border-radius:5px;border:#00cdc1;" type="text" name="Username" required="required" id="Username">
			</div>
            <br>
            ...
            <br>
            <strong style="font-size:14px;">Confirm Password:</strong>
            <div style="text-align: center" class="wrap-input100 validate-input">
						<input class="input100" style="background-color:#f1f1f1;width:300px;height:40px;border-radius:5px;border:#00cdc1;" type="password" name="Password" required="required" id="Password">
              ...
              <input type="submit" name="Changepassword" value="Change Password" class="btn btn-block btn-primary" style="background-color:#00cdc1;border:#00cdc1;height:50px;">
              <br>
