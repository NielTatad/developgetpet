      ...
      <div class="x_content" style="text-align:center;">
       ...
       <!-- View Post for Tips Advice & Articles Code -->
                  <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" href="http://localhost/developgetpet/dashboard/P.O-Advice.php" role="tab" aria-controls="advice-tab" aria-selected="false">Advice</a>
                      </li>
                      <li class="nav-item">
                        <a href="http://localhost/developgetpet/dashboard/P.O-Articles.php" role="tab" aria-controls="articles-tab" aria-selected="false">Articles</a>
                      </li>
                    </ul>
...
<!-- //Post Tips Code -->
                      ...
                      <div class="field item form-group">
                                         ...
                                         <div hidden class="field item form-group">
                                             <div class="col-md-6 col-sm-6">
                                                 <input class="form-control" data-validate-length-range="6" data-validate-words="2" name="ID" value="<?php echo ($result->onwerID);?>"/>
                                             </div>
