...
if(isset($_POST['btnComment']))
{
  ...
  if($masterid == $ID)
  {
    ...
    echo "<script type ='text/javascript'> document.location='http://localhost/developgetpet/dashboard/P.-Shorttermcare.php'</script>";
  ...
  else
  {
    ...
    echo '<script>alert("Your Comment Posted Successfully!")</script>';
    echo "<script type ='text/javascript'> document.location='http://localhost/developgetpet/dashboard/P.A-Shorttermcare.php'</script>";
  }
