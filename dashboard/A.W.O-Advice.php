      ...
      <div class="x_content" style="text-align:center;">
       ...
       <!-- View Post for Tips Advice & Articles Code -->
                  <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
                      <li class="nav-item">
                        <a href="http://localhost/developgetpet/dashboard/A.W.O-Tips.php" role="tab" aria-controls="tips-tab" aria-selected="true">Tips</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" href="http://localhost/developgetpet/dashboard/A.W.O-Advice.php" role="tab" aria-controls="advice-tab" aria-selected="false">Advice</a>
                      </li>
                      <li class="nav-item">
                        <a href="http://localhost/developgetpet/dashboard/A.W.O-Articles.php" role="tab" aria-controls="articles-tab" aria-selected="false">Articles</a>
                      </li>
                    </ul>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" id="post-advice-tab" data-toggle="tab" href="#post_advice" role="tab" aria-controls="post-advice-tab" aria-selected="false">Post Advice</a>
                      </li>
...
<!-- //Post Tips Code -->
                      ...
                      <div class="tab-pane fade show active" id="post_advice" role="tabpanel" aria-labelledby="post-advice-tab">
