            ...
            <div class="row">
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel" style="border-radius:10px;border-width:2px;">
                  ...
                  <div class="page-title">
                  <div class="title_left">
                  <h2>Available Dog's For Short-Term Care</h2> 
                  </div>                               
                  ...
                  <?php
                        $sql="SELECT * from postpet WHERE petStatus='Available' AND postStatus='Short-term care' AND postStatus!='Deleted' AND petType='Dog' ORDER BY petID DESC";
                        $query=$dbh->prepare($sql);
                        $query->execute();
                        $results=$query->fetchALL(PDO::FETCH_OBJ);
                        $cnt=1;
                                    ...
                                    <div class="col-nd-4">
                                        <div class="card" style="border-radius:10px;border-width:2px;width:550px;margin: 0 auto;float: none; margin-bottom: 10px;">
                                          ...
                                          <br>
                                              ...
                                              <?php $cnt1=$cnt1+1;}} ?>
                                              <button type="button" class="btn btn-link viewbtn" style="height:30px;width:150px;font-size:14px;margin-top:-10px;float:left;margin-left:-25px;" data-selected-range="<?php echo ( $result->selectedRange);?>">View Info</button><button type="button" class="btn btn-success stcbtn" id="stcbtn" style="height:35px;width:150px;font-size:14px;margin-top:-10px;float:center;margin-right:140px;background-color:#00cdc1;color:white;"  data-selected-range="<?php echo ( $result->selectedRange);?>"><i hidden><?php echo ( $result->userID);?></i> Take Care Me</button>
                                              <br>
...
if(isset($_POST['Short-Term-Care']))
{
  ...
  echo "<script type ='text/javascript'> document.location='http://localhost/developgetpet/dashboard/P.O-Dogsshorttermcare.php'</script>";
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form method="post">
        ...
        <div hidden class="field item form-group">
        <label class="col-form-label col-md-3 col-sm-3  label-align">Selected Range<span class="required"></span></label>
        <div class="col-md-6 col-sm-6">
               <input readonly type="text" class="form-control" id="selected_range" name="selectedRange" style="background-color:#fff;width:400px;" required="required"/>
        </div>
        </div>
        ...
        <div class="col-md-6 col-sm-6">
        <textarea name="Reason" id="Reason" style="width:400px;height:100px;padding-top:-5px;background-color: #fff;resize: none;font-size:16px;" required = "required" placeholder="Write your reason to take care of this pet..." onkeyup="request()"></textarea>
        </div>
        </div>
        <script>
          function request() {
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form method="post">
        ...
        <div class="col-md-6 col-sm-6">
               <input readonly type="text" class="form-control" id="selected_range1" name="selectedRange" style="background-color:#fff;width:400px;" required="required"/>
        </div>
        </div>
...
if(isset($_POST['btnComment']))
{
  ...
  if($masterid == $ID)
  {
    ...
    echo "<script type ='text/javascript'> document.location='http://localhost/developgetpet/dashboard/P.-Dogsshorttermcare.php'</script>";
  ...
  else
  {
    ...
    echo '<script>alert("Your Comment Posted Successfully!")</script>';
    echo "<script type ='text/javascript'> document.location='http://localhost/developgetpet/dashboard/P.A-Dogsshorttermcare.php'</script>";
  }
...
<script type="text/javascript">
 ...
 <script type="text/javascript">
  ...
  return $(this).text().trim() == "<?php echo $ID?> Take Care Me";
