                  ...
                  <div class="x_content" style="text-align:center;">
                    ...
                    <form class="" action="" method="post" novalidate enctype="multipart/form-data">
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <button type="button" onclick="window.location.href='http://localhost/developgetpet/dashboard/P.O-ChangeContactNo.php';" class="form-control" style="background-color:#e9ecef;width:170px;" required="required">Change Contact No.</button>
                                            </div>
                                        </div>
                                        <div class="field item form-group">
