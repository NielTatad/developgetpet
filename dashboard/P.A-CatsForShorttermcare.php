...
if(isset($_POST['Go']))
{
  if($Search = $_POST['Search'] == "")
  {
   ...
   echo "<script type ='text/javascript'> document.location='http://localhost/developgetpet/dashboard/P.A-CatsForShortermcare.php'</script>";
...
if(isset($_POST['Short-Term-Care']))
{
  ...
  echo "<script type ='text/javascript'> document.location='http://localhost/developgetpet/dashboard/P.A-CatsForShorttermcare.php'</script>";
