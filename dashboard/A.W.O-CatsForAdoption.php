            ...
            <div class="row">
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel" style="border-radius:10px;border-width:2px;">
                  <div class="x_title">
                    <h2>Available Cat For Adoption</h2>
                     <!-- Post Button -->
                  ...
                  <?php
                        $sql="SELECT * from postpet WHERE petStatus='Available' AND petType='Cat' AND postStatus='Adoption' AND postStatus!='Deleted' ORDER BY petID DESC";
                        $query=$dbh->prepare($sql);
                        $query->execute();
                        $results=$query->fetchALL(PDO::FETCH_OBJ);
                        $cnt=1;
