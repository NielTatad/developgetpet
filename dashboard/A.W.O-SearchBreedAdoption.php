...
if(isset($_POST['Go']))
{
  if($Search = $_POST['Search'] == "")
  {
   ...
   echo "<script type ='text/javascript'> document.location='http://localhost/developgetpet/dashboard/A.W.O-SearchBreedAdoption.php'</script>";
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel" style="border-radius:10px;border-width:2px;">
                  <div class="x_title">
                    <h2>Available <?php echo $Search ?> For Adoption</h2>
                     <!-- Post Button -->
                  ...
                  <?php
                    ...
                    {
                      echo "<script type ='text/javascript'> document.location='http://localhost/developgetpet/dashboard/A.W.O-CatsForAdoption.php'</script>";
                    }
                    if($Search == "DOG" || $Search == "Dog" || $Search == "dog" || $Search == "DOGS" || $Search == "Dogs" || $Search == "dogs")
                    {
                      echo "<script type ='text/javascript'> document.location='http://localhost/developgetpet/dashboard/A.W.O-DogsForAdoption.php'</script>";
                    }

                    else
                    {
                      $sql="SELECT * from postpet WHERE petStatus='Available' AND postStatus='Adoption' AND petBreed='$Search' AND postStatus!='Deleted' ORDER BY petID DESC";
                        $query=$dbh->prepare($sql);
                        $query->execute();
                        $results=$query->fetchALL(PDO::FETCH_OBJ);
                        $cnt=1;
...
<script type="text/javascript">
 ...
 <script type="text/javascript">
  ...
  return $(this).text().trim() == "Adopt Me";
