...
if(isset($_POST['Go']))
{
  if($Search = $_POST['Search'] == "")
  {
   ...
   echo "<script type ='text/javascript'> document.location='http://localhost/developgetpet/dashboard/P.A-DogsForShorttermcare.php'</script>";
  ...
  else
  {
   ...
   echo "<script type ='text/javascript'> document.location='http://localhost/developgetpet/dashboard/P.A-SearchBreedShorttermcare.php'</script>";
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel" style="border-radius:10px;border-width:2px;">
                  ...
                  <?php
                        $sql="SELECT * from postpet WHERE petStatus='Available' AND petType='Dog' AND postStatus='Short-term care' AND postStatus!='Deleted' ORDER BY petID DESC";
                        $query=$dbh->prepare($sql);
                        $query->execute();
                        $results=$query->fetchALL(PDO::FETCH_OBJ);
                        $cnt=1;
