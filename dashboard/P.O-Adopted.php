            ...
            <div class="row">
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel" style="border-radius:10px;border-width:2px;">
                  ...
                  <div class="card" style="width: 18rem;box-shadow: 8px 8px 8px #888888;border-radius:10px;">
                  <br>
                    <img <?php echo"<img src = '/developgetpet/web/images/$result->petPicture'";?> class="card-img-top" height="220" alt="..." style="border-radius:3px;">
                    <div class="card-body">
                      <h5 class="card-title"><?php echo ($result->postStatus);?></h5>
