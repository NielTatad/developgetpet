...
?>  
					    ...
					    <img <?php echo"<img src = '/developgetpet/web/images/$result->orgLogo'";?> alt="avatar" style="width:80px;height:80px;border-radius:10px;margin-right:10px;float:left;" class="rounded-circle img-responsive">&nbsp;<textarea name="Message" required = "required" class="form-control" id="message" placeholder="Write a message..." style="background-color:#EAEDF0;border-radius:10px;height:100px;width:700px;resize: none;font-size:16px;float:left" onkeyup="request()"></textarea>
                        <script>
                        function request() {
