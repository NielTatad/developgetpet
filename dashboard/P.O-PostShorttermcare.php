...
<!-- //Post Pet Code -->
                     ...
                     <!-- Back Button -->
                     <a href="http://localhost/developgetpet/dashboard/P.O-Shorttermcare.php"><button data-toggle="tooltip" data-placement="top" title="Back" type="button" class="btn btn-round btn-success" style="background-color:#00cdc1;border:#00cdc1;"><i class="fa fa-arrow-left" style="font-size:30px;color:#White;"></i></button></a>
                    <!-- //Back Button -->
