  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="post">
        ...
        <div style="text-align: center" class="wrap-input100 validate-input">
					    <input hidden name="Email" value="<?php echo $result->adopterEmail; ?>" required = "required" class="form-control">
				</div>
        <div style="text-align: center" class="wrap-input100 validate-input">
					    <input hidden name="Name" value="<?php echo $result->adopterFirstname; ?> <?php echo $result->adopterLastname; ?>" required = "required" class="form-control">
				</div>
        <div style="text-align: center" class="form-group">
         <div class="col-md-6 offset-md-3">
