...
if(isset($_POST['update']))
    {
        ...
        if($New_Username= $_POST['New_Username'] == "")
        {
            ...
            echo "<script type ='text/javascript'> document.location='http://localhost/developgetpet/dashboard/P.O-ChangeUsername.php'</script>";
        ...
        else
        {
          ...
          else
          {
              ...
              else
              {
                  ...
                  $sql1="update petowner set ownerUsername=:New_Username where ownerID='$ID'";
                ...
                <div class="x_panel" style="border-radius:10px;border-width:2px;">
                  ...
                  <form class="" action="" method="post" novalidate enctype="multipart/form-data">
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input readonly type="text" class="form-control" name="Username" value="<?php echo ( $result->ownerUsername);?>" style="background-color:#fff;" required="required"/>
                                            </div>
                                        </div>
                                        <br>
                                        <div class="field item form-group">
