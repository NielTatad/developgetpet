              ...
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel" style="border-radius:10px;border-width:2px;">
                  ...
                  <?php
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" href="http://localhost/developgetpet/dashboard/P.O-PostDogsShorttermcare.php" role="tab" aria-controls="post_short-term-care" aria-selected="false">Post Dogs Short-Term Care</a>
                      </li>
                      <li class="nav-item">
                ...
                <!-- View Pet Post for Short-term Care Code -->
                  <?php
                        $sql="SELECT * from postpet WHERE userID='$ID' AND petStatus='Available' AND petType='Dog' AND postStatus='Short-term care' AND postStatus!='Deleted' ORDER BY petID DESC";
                        $query=$dbh->prepare($sql);
                        $query->execute();
                        $results=$query->fetchALL(PDO::FETCH_OBJ);
                        $cnt=1;
...
if(isset($_POST['Short-Term-Care']))
{
  ...
  echo "<script type ='text/javascript'> document.location='http://localhost/developgetpet/dashboard/P.O-PostDogsShorttermcare.php'</script>";
  ...
  $receiver = $userEmail;
  $subject = "Short-Term Care Request";
  $body = "$Name\n$Reason";
  $sender = $Email;
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div style="text-align: center" class="wrap-input100 validate-input">
        ...
        <div class="col-md-6 col-sm-6">
        <textarea name="Reason" id="Reason" style="width:400px;height:150px;padding-top:-5px;background-color: #fff;resize: none;font-size:16px;" required = "required" placeholder="Write your reason to short-term care..." onkeyup="request()"></textarea>
        </div>
        </div>
        <script>
          function request() {
