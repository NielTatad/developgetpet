...
$query->bindParam(':orgAddress',$orgAddress,PDO::PARAM_STR);
$query->execute();
...
$query1->bindParam(':orgName',$orgName,PDO::PARAM_STR);
$query1->bindParam(':orgAddress',$orgAddress,PDO::PARAM_STR);
$query1->execute();
...
$query3->bindParam(':orgName',$orgName,PDO::PARAM_STR);
$query3->bindParam(':orgAddress',$orgAddress,PDO::PARAM_STR);
$query3->execute();
{
echo '<script>alert("Your Account Updated Successfully!")</script>';
echo "<script type ='text/javascript'> document.location='http://localhost/developgetpet/dashboard/A.W.O-AccountSettings.php'</script>";
}
}
?>
<!DOCTYPE html>
                    ...
                    <form class="" action="" method="post" novalidate enctype="multipart/form-data">
                                         ...
                                         <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input type="text" class="form-control" name="orgName" value="<?php echo ( $result->orgName);?>" required="required"/>
                                            </div>
                                        </div>
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Address<span class="required"></span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input type="text" class="form-control" name="orgAddress" value="<?php echo ( $result->orgAddress);?>" required="required"/>
                                            </div>
                                        </div>
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Email<span class="required"></span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input readonly type="email" class="form-control" name="orgEmail" value="<?php echo ( $result->orgEmail);?>" style="background-color:#fff;" required="required"/>
                                            </div>
                                        </div>
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Contact No<span class="required"></span></label>&nbsp;&nbsp;&nbsp;<input readonly type="number" class="form-control" name="ContactNo" value="<?php echo ( $result->orgContactNo);?>" style="background-color:#fff;width:230px;" required="required"/>
                                            <div class="col-md-6 col-sm-6">
                                                <button type="button" onclick="window.location.href='http://localhost/developgetpet/dashboard/A.W.O-ChangeContactNo.php';" class="form-control" style="background-color:#e9ecef;width:170px;" required="required">Change Contact No.</button>
                                            </div>
                                        </div>
                                        <div class="field item form-group">
                                        ...
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Username<span class="required"></span></label>&nbsp;&nbsp;&nbsp;<input readonly type="text" class="form-control" name="Username" value="<?php echo ( $result->orgUsername);?>" style="background-color:#fff;width:230px;" required="required"/>
                                            <div class="col-md-6 col-sm-6">
                                                <button type="button" onclick="window.location.href='http://localhost/developgetpet/dashboard/A.W.O-ChangeUsername.php';" class="form-control" style="background-color:#e9ecef;width:160px;" required="required">Change Username</button>
                                            </div>
                                        </div>
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Password<span class="required"></span></label>&nbsp;&nbsp;&nbsp;<input readonly type="password" class="form-control" name="Password" value="<?php echo ( $result->orgPassword);?>" style="background-color:#fff;width:230px;" required="required"/>
                                            <div class="col-md-6 col-sm-6">
                                                <button type="button" onclick="window.location.href='http://localhost/developgetpet/dashboard/A.W.O-ChangePassword.php';" class="form-control" style="background-color:#e9ecef;width:160px;" required="required">Change Password</button>
                                            </div>
                                        </div>
                                        <div class="ln_solid">
                                            <br>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-6 offset-md-3">
                                                    ...
                                                    <button onclick="window.location.href='http://localhost/developgetpet/dashboard/A.W.O-AccountSettings.php';" type='reset' class="btn btn-danger" name="Reset" style="width:120px;height:40px;">Reset</button>
                                                </div>
                                            </div>
                                            </div>
                                            </div>
