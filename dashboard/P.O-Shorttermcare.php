...
<?php }} ?>
    ...
    <div class="right_col" role="main">
          <div class="">
            ...
            <!-- Post Button -->
            <a href="http://localhost/developgetpet/dashboard/P.O-PostShorttermcare.php"><button data-toggle="tooltip" data-placement="top" title="Post Pet" type="button" class="btn btn-round btn-success" style="background-color:#00cdc1;border:#00cdc1;"><i class="fa fa-plus" style="font-size:30px;color:#White;"></i></button></a>
            <!-- //Post Button -->
