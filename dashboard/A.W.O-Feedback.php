              ...
              <div class="card" style="border-radius:10px;border-width:2px;">                 
                  ...
                  <h3>User Feedback</h3>
                    ...
                    else
                    {
                        ...
                        echo "<script type ='text/javascript'> document.location='http://localhost/developgetpet/dashboard/A.W.O-ViewReviews.php'</script>";
                    }
