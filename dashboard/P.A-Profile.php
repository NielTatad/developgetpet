                        ...
                        <div class="col-nd-4">
                            <div class="card">
                              <div class="card-body">
                                  ...
                                  <Img <?php echo"<img src = '/developgetpet/web/images/$result->adopterPicture'";?> class="rounded-circle img-responsive" alt="Post Images" style="height:300px;width:300px;">
                ...
                <div class="card">
                  <div class="card-body">
                      ...
                      if($query1->rowCount()>0)
                      {
                        ...
                        {
                            echo "You have no any post activity yet.";
                        }
                        ?>
         <!-- //View Pet Post for Adotion Code -->
...
<!-- ModalProfile -->
  <div class="modal fade" id="Profiles" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h4 class="modal-title w-100 font-weight-bold" style="margin-left:20px;">&nbsp&nbspProfile Picture</h4>
      ...
      <form method="post">
        ...
        <div style="text-align: center">
						  <button  class="btn btn-round btn-success" style="background-color:#00cdc1;width:200px;height:35px;border:none;" name="profile" type="submit" id="insert" value="Insert">
							 <a style="color:White"> Update Profile Picture</a>
						 </button>
				</div>
