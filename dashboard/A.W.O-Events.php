  ...
  <div class="col-md-12 col-sm-12">
    <div class="x_panel" style="border-radius:10px;border-width:2px;">
      <div class="x_title">
        <h2>Posted Events</h2>
         <!-- Post Button -->
         <a href="http://localhost/developgetpet/dashboard/A.W.O-Postevent.php"><button type="button" class="btn btn-round btn-success" style="background-color:#00cdc1;border:#00cdc1;width:150px;float:right;">Create Event</button></a>
