              ...
              <div class="col-md-12 col-sm-12">
                <div class="x_panel" style="border-radius:10px;border-width:2px;">
                  ...
                  <?php
                    ...
                    <a class="dropdown-item" href="http://localhost/developgetpet/dashboard/P.A-DogsForAdoption.php"><li class="fas fa-dog"></li>&nbsp View Dog For Adoption</a>
                    <a class="dropdown-item" href="http://localhost/developgetpet/dashboard/P.A-CatsForAdoption.php"><li class="fas fa-cat"></li>&nbsp View Cat For Adoption</a>
                    </ul>
                    </h2>
      </div>
    </div>
              ...
              <div class="col-md-12 col-sm-12">
                <div class="x_panel" style="border-radius:10px;border-width:2px;">
                  ...
                  <?php
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    <a class="dropdown-item" href="http://localhost/developgetpet/dashboard/P.A-DogsForShorttermcare.php"><li class="fas fa-dog"></li>&nbsp View Dog For Short-term care</a>
                    <a class="dropdown-item" href="http://localhost/developgetpet/dashboard/P.A-CatsForShorttermcare.php"><li class="fas fa-cat"></li>&nbsp View Cat For Short-term care</a>
                    </ul>
                    </h2>
