              ...
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel" style="border-radius:10px;border-width:2px;">
                  ...
                  <?php
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" href="http://localhost/developgetpet/dashboard/A.W.O-PostCatsAdoption.php" role="tab" aria-controls="post_adoption" aria-selected="false">Post Cats Adoption</a>
                      </li>
                      <li class="nav-item">
                    ...
                    <div class="tab-content" id="myTabContent">
                      ...
                      <div class="x_content" style="text-align:center;">
                                  ...
                                  <?php
                                        $sql="SELECT * from postpet WHERE userID='$ID' AND petType='Cat' AND petStatus='Available' AND postStatus='Adoption' AND postStatus!='Deleted' ORDER BY petID DESC";
                                        $query=$dbh->prepare($sql);
                                        $query->execute();
                                        $results=$query->fetchALL(PDO::FETCH_OBJ);
                                        $cnt=1;
                                                        ...
                                                        <div class="card" style="border-radius:10px;border-width:2px;width:550px;margin: 0 auto;float: none; margin-bottom: 10px;">
                                                          ...
                                                          <br>
                                                                ...
                                                                foreach($pictures as $picture)
                                                              {
                                                                ...
                                                                <label style="margin-top:-30px;"><img <?php echo"<img src = '/developgetpet/web/images/$picture->Image'";?> alt="avatar" style="width:30px;height:30px;margin-top:10px;" class="rounded-circle img-responsive">&nbsp<textarea disabled="yes" class="txtgrow" style="width:450px;height:auto;font-size:16px;border-radius:20px; background-color:#e9ecef;resize: none;overflow:hidden;font-size:14px;text-align:left;padding-top: 10px;color: #808080;margin-top:10px;" type='text'><?php echo ( $picture->orgName);?><?php echo ( $picture->userFirstname);?> <?php echo ( $picture->userLastname);?>&#13;&#10;<?php echo ( $comment->commentContent);?></textarea>&nbsp&nbsp<i class="fa fa-ellipsis-v option" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></i>
...
if(isset($_POST['Adopt']))
{
  ...
  echo "<script type ='text/javascript'> document.location='http://localhost/developgetpet/dashboard/A.W.O-PostCatsAdoption.php'</script>";
  ...
  echo "<script type ='text/javascript'> document.location='http://localhost/developgetpet/dashboard/A.W.O-MyRequest.php'</script>";
    ...
    <div class="modal-content">
      ...
      <form method="post">
        ...
        <div hidden style="text-align: center" class="wrap-input100 validate-input">
					    <input type="text" name="UserID" value="<?php echo ($result->orgID);?>"  required = "required" class="form-control">

              <input readonly type="text" class="form-control" name="Name" value="<?php echo ($result->orgName);?>" style="background-color:#fff;width:400px;" required="required"/>

              <input readonly type="text" class="form-control" name="Email" value="<?php echo ($result->orgEmail);?>" style="background-color:#fff;width:400px;" required="required"/>

              <input readonly type="text" class="form-control" name="Address" value="<?php echo ($result->orgAddress);?>" style="background-color:#fff;width:400px;" required="required"/>

              <input readonly type="text" class="form-control" name="ContactNo" value="<?php echo ($result->orgContactNo);?>" style="background-color:#fff;width:400px;" required="required"/>

        </div>
        <div style="text-align: center" class="wrap-input100 validate-input">
					    <input hidden type="text" id="user_email" name ="userEmail" required = "required" class="form-control">
				</div>
