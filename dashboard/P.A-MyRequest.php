                  ...
                  <h3 class="request-title"><?php echo ($result->requestTitle);?></h3>
                      ...
                      <?php
                        if(isset($_POST['ViewProfile']))
                        {
                          ...
                          echo "<script type ='text/javascript'> document.location='http://localhost/developgetpet/dashboard/P.A-ViewProfile.php'</script>";
                          $_SESSION['masterID'] = $masterID;
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="post">
        ...
        <div style="text-align: center" class="wrap-input100 validate-input">
					    <input hidden type="text" name="Email" value="<?php echo $result->adopterEmail;?>" required = "required" class="form-control">
				</div>
        <div style="text-align: center" class="form-group">
         <div class="col-md-6 offset-md-3">
