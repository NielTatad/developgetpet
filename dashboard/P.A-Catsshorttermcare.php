            ...
            <div class="row">
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel" style="border-radius:10px;border-width:2px;">
                  ...
                  <div class="page-title">
                  <div class="title_left">
                  <h2>Available Cat's For Short-Term Care</h2> 
                  </div>                               
                  ...
                  <?php
                        $sql="SELECT * from postpet WHERE petStatus='Available' AND postStatus='Short-term care' AND postStatus!='Deleted' AND petType='Cat' ORDER BY petID DESC";
                        $query=$dbh->prepare($sql);
                        $query->execute();
                        $results=$query->fetchALL(PDO::FETCH_OBJ);
                        $cnt=1;
...
if(isset($_POST['Short-Term-Care']))
{
  ...
  echo "<script type ='text/javascript'> document.location='http://localhost/developgetpet/dashboard/P.O-Catsshorttermcare.php'</script>";
...
if(isset($_POST['btnComment']))
{
  ...
  if($masterid == $ID)
  {
    ...
    echo "<script type ='text/javascript'> document.location='http://localhost/developgetpet/dashboard/P.-Catsshorttermcare.php'</script>";
