           ...
           <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <li>
                    ...
                    <li>
                    <li class="current-page"><a href="http://localhost/developgetpet/dashboard/A.W.O-Donation.php">Donation</a>
                    </li>
...
?>
                    ...
                    <!-- Back Button -->
                    <a href="http://localhost/developgetpet/dashboard/A.W.O-Donation.php"><button type="button" class="btn btn-round btn-success" style="background-color:#00cdc1;border:#00cdc1;">Back</button></a>
