...
if(isset($_POST['update']))
    {
        ...
        if($ContactNo = $_POST['ContactNo'] == $New_ContactNo= $_POST['New_ContactNo'])
        {
            ...
            echo "<script type ='text/javascript'> document.location='http://localhost/developgetpet/dashboard/A.W.O-ChangeContactNo.php'</script>";
        ...
        else
        {
            ...
            else
            {
                ...
                $sql1="update animalwelfareorganization set orgContactNo=:New_ContactNo where orgID='$ID'";
                ...
                <div class="x_panel" style="border-radius:10px;border-width:2px;">
                  ...
                  <form class="" action="" method="post" novalidate enctype="multipart/form-data">
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input readonly type="text" class="form-control" name="ContactNo" value="<?php echo ( $result->orgContactNo);?>" style="background-color:#fff;" required="required"/>
                                            </div>
                                        </div>
                                        <br>
                                        <div class="field item form-group">
