...
if(isset($_POST['update']))
    {
      ...
      if($New_Password= $_POST['New_Password'] == "")
      {
          ...
          echo "<script type ='text/javascript'> document.location='http://localhost/developgetpet/dashboard/P.A-ChangePassword.php'</script>";
      ...
      else
      {
        if($New_Password = $_POST['New_Password'] == $Confirm_New_Password = $_POST['Confirm_New_Password'])
        {
          ...
          else
          {
              ...
              $sql1="update petadopter set adopterPassword=:New_Password where adopterID='$ID'";
                ...
                <div class="x_panel" style="border-radius:10px;border-width:2px;">
                  ...
                  <form class="" action="" method="post" novalidate enctype="multipart/form-data">
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input readonly type="text" class="form-control" name="Password" value="<?php echo ( $result->adopterPassword);?>" style="background-color:#fff;" required="required"/>
                                            </div>
                                        </div>
                                        <br>
                                        <div class="field item form-group">
