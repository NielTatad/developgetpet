            ...
            <div class="row">
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel" style="border-radius:10px;border-width:2px;">
                  ...
                  <div class="page-title">
                  <div class="title_left">
                  <h2>Available Dog's For Adoption</h2> 
                  </div>                 
...
if(isset($_POST['Adopt']))
{
  ...
  echo "<script type ='text/javascript'> document.location='http://localhost/developgetpet/dashboard/P.O-Dogslistadoption.php'</script>";
