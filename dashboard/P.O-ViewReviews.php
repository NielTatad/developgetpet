                ...
                <div class="x_panel" style="border-radius:10px;border-width:2px;">
                  ...
                  <?php
                    ...
                    <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
                      <li class="nav-item">
                        <a href="http://localhost/developgetpet/dashboard/P.O-ViewAbout.php" role="tab" aria-controls="about" aria-selected="false">About</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" href="http://localhost/developgetpet/dashboard/P.O-ViewReviews.php" role="tab" aria-controls="post_adoption" aria-selected="false">Reviews</a>
                      </li>
                    </ul>
                    <?php $cnt=$cnt+1;}} ?>
