...
if(isset($_POST['update']))
    {
        ...
        if($New_Username= $_POST['New_Username'] == "")
        {
            ...
            echo "<script type ='text/javascript'> document.location='http://localhost/developgetpet/dashboard/P.A-ChangeUsername.php'</script>";
        ...
        else
        {
          ...
          else
          {
              ...
              else
              {
                  ...
                  $sql1="update petadopter set adopterUsername=:New_Username where adopterID='$ID'";
                  ...
                  <form class="" action="" method="post" novalidate enctype="multipart/form-data">
                                        ...
                                        <div hidden class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input type="text" class="form-control" name="Email" value="<?php echo ( $result->adopterEmail);?>" required="required"/>
                                            </div>
                                        </div>
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Current Username<span class="required"></span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input readonly type="text" class="form-control" name="Username" value="<?php echo ( $result->adopterUsername);?>" style="background-color:#fff;" required="required"/>
                                            </div>
                                        </div>
                                        <br>
                                        <div class="field item form-group">
