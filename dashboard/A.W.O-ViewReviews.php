                ...
                <div class="x_panel" style="border-radius:10px;border-width:2px;">
                  ...
                  <?php
                    ...
                    <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
                      <li class="nav-item">
                        <a href="http://localhost/developgetpet/dashboard/A.W.O-ViewAbout.php" role="tab" aria-controls="about" aria-selected="false">About</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" href="http://localhost/developgetpet/dashboard/A.W.O-ViewReviews.php" role="tab" aria-controls="post_adoption" aria-selected="false">Reviews</a>
                      </li>
                    </ul>
                    <?php $cnt=$cnt+1;}} ?>
...
$sql="SELECT * from feedback WHERE masterID='$masterID'";
$query=$dbh->prepare($sql);
$query->execute();
$results=$query->fetchALL(PDO::FETCH_OBJ);
$cnt=1;
