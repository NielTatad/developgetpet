  ...
  <div class="col-md-12 col-sm-12  ">
    <div class="x_panel" style="border-radius:10px;border-width:2px;">
      ...
      <br>  
            ...
            <?php
                        $sql="SELECT * from donation WHERE masterID='$ID' AND donationStatus='Not Recieved Yet' ORDER BY donationID DESC";
                        $query=$dbh->prepare($sql);
                        $query->execute();
                        $results=$query->fetchALL(PDO::FETCH_OBJ);
                        $cnt=1;
                                    ...
                                    <div class="col-nd-4">
                                        <div class="card" style="border-radius:10px;border-width:2px;width:550px;margin: 0 auto;float: none; margin-bottom: 10px;">
                                            ...
                                            foreach($userids as $userid)
                                          {
                                            ...
                                            <button type="button" class="btn btn-success messagebtn" style="background-color:#00cdc1;border:#00cdc1;height:35px;width:140px;" data-char-title="in donating <?php echo ($charid->charityTitle);?>" data-donation-id="<?php echo ($result->donationID);?>">Give Credits</button>
